...
export default function WhatsAppFloat() {
  ...
  const openWhatsApp = () => {
    window.open(
      `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
        "Hello Prime Vista Journey, I want to know more about your travel packages."
      )}`,
      "_blank"
    );
  };
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-[9998] w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] text-white shadow-xl flex items-center justify-center hover:scale-110 transition-all duration-300"
    >
      {/* WhatsApp Icon */}
      <svg
