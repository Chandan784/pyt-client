      ...
      {itinerary.map((day, index) => (
        ...
        >
          <div className="flex items-start gap-4">
            {/* DAY CIRCLE */}
            <div className="bg-yellow-500 text-white w-12  h-12 rounded-full flex items-center justify-center font-bold  text-sm shrink-0">
              {day.day}
            </div>
            ...
            <div className="flex-1">
              ...
              {/* ✅ FIXED MEALS (STRING OR ARRAY SAFE) */}
              {day.meals && (
